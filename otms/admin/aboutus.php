...
$pagedes=$_POST['pagedes'];
     $query=mysqli_query($con,"update page set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='aboutus'");
    if ($query) {
...
<head>
  ...
  <title>Online Temple Management System || About Us Page</title>
  <!-- base:css -->
