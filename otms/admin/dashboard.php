                ...
                <div class="card-body py-5">
                  <div
                    ...
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query1=mysqli_query($con,"Select * from  bookdarshan");
$newbooking=mysqli_num_rows($query1);
?>
                      <h5 class="text-white font-weight-bold"> All Darshan Booking- <?php echo $newbooking;?></h5>
                      <a href="all-booking.php"><p class="mt-2 text-white card-text">View Detail</p></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card bg-google d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    ...
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query2=mysqli_query($con,"Select * from  bookpooja");
$acceptedbooking=mysqli_num_rows($query2);
?>
                      <h5 class="text-white font-weight-bold">ALL Pooja Booking- <?php echo $acceptedbooking;?></h5>
              ...
              <div class="card bg-twitter d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query3=mysqli_query($con,"Select * from  bookabhishek");
$rejectedbooking=mysqli_num_rows($query3);
?>
                     <h5 class="text-white font-weight-bold"> All Abhishek Booking- <?php echo $rejectedbooking;?></h5>
              ...
              <div class="card bg-facebook d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query4=mysqli_query($con,"Select * from  donation");
              ...
              <div class="card bg-google d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query5=mysqli_query($con,"Select * from  temple ");
              ...
              <div class="card bg-twitter d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    class="d-flex flex-row align-items-center flex-wrap justify-content-md-center justify-content-xl-start py-1">
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <?php $query7=mysqli_query($con,"Select * from  devotees");
