<nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <h4 style="color: white; padding-right: 20px;padding-left: 20px;">Smart Temple System</h4>
          </div>
          <?php
$admid=$_SESSION['aid'];
$ret=mysqli_query($con,"select AdminName from admin where ID='$admid'");
...
?></h4>
            ...
            <li class="nav-item dropdown mr-1">
              <?php
$ret1=mysqli_query($con,"select devotees.FirstName,bookdarshan.ID,bookdarshan.BookingNumber,BookingDate from bookdarshan join devotees on devotees.ID=bookdarshan.UserId where bookdarshan.Status is null || bookdarshan.Status=''");
