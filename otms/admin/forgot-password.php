...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
$password=$_md5 ($_POST['newpassword']);
        $query=mysqli_query($con,"select ID from devotees where  Email='$email' and MobileNumber='$contactno' ");
		...
		<div class="container">
			<h2>Forgot Password!!</h2>
             ...
             <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                <a href="login.php" class="btn btn-success"><i class="ft-user"></i> Login</a> 
              </div>
						</form>	
		</div>
	</div>
