...
$sql=mysqli_query($con,"insert into pooja(TempleID,PoojaName,Price) values('$tid','$pname','$price')");
echo "<script>alert('Pooja detail has been added successfully');</script>";
...
<head>
  ...
  <title>Online Temple Management System || Add Pooja</title>
  <!-- base:css -->
