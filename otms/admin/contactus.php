...
$email=$_POST['email'];
 $mobnum=$_POST['mobnum'];
     $query=mysqli_query($con,"update page set PageTitle='$pagetitle',PageDescription='$pagedes',Email='$email',MobileNumber='$mobnum' where  PageType='contactus'");
    if ($query) {
...
<head>
  ...
  <title>Online Temple Management System || Contact Us Page</title>
  <!-- base:css -->
